...
SELECT
  ...
  STRING_AGG(person_id::text, ', ' ORDER BY total_messages_sent DESC) FILTER (WHERE total_messages_sent > 500) as top_user_ids
FROM user_personas
GROUP BY persona
...
**Expected Output:**
```
persona             | user_count | avg_total_messages | avg_reactions | avg_weekly_messages | pct_1on1 | avg_active_hour | top_user_ids
--------------------+------------+--------------------+---------------+---------------------+----------+-----------------+-----------------------
Churned             |         27 |                180 |             5 |                   0 |     10.1 |              15 | 42, 87, ...
1:1 Coaching Seeker |         14 |                385 |             0 |                  17 |     83.5 |              13 | 103, ...
Power User          |         11 |               2832 |           234 |                 166 |      3.2 |              13 | 7, 19, ...
Feedback Giver      |         11 |                275 |            38 |                   2 |      3.8 |              14 | 55, ...
Engaged Couple      |          7 |               1046 |            53 |                  82 |      5.8 |              14 | 31, ...
At Risk Churn       |          6 |                821 |            33 |                   0 |      8.9 |              14 | 64, ...
Other               |          6 |                700 |            24 |                  11 |     24.2 |              13 | 112, ...
