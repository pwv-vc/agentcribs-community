...
ORDER BY ou.cohort_week, ou.onboarding_completed_at, ou.person_id;
```
...
ORDER BY ou.cohort_week, ou.person_id;
```
...
ORDER BY cohort_week, person_id, day_number;
```
